...
THEATERS = {AMC25, ANGELIKA, VILLAGE_EAST, QUAD, FILM_FORUM, WALTER_READE, IFC, ELINOR, METROGRAPH}

WEEKDAY_THEATERS = [AMC25, FILM_FORUM, IFC, QUAD, WALTER_READE, ELINOR]
