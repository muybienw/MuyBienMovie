...
THEATERS = {AMC_LOWES_34, AMC_LINCOLN_SQUARE, REGAL_UNION_SQUARE, ANGELIKA, VILLAGE_EAST, QUAD, FILM_FORUM, WALTER_READE, IFC, ELINOR, METROGRAPH}

WEEKDAY_THEATERS = [AMC_LOWES_34, AMC_LINCOLN_SQUARE, REGAL_UNION_SQUARE, FILM_FORUM, IFC, QUAD, WALTER_READE, ELINOR]
